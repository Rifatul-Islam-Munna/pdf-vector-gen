...
const styles = StyleSheet.create({
 page: {
  ...
  // Left side - PRIVATE AND CONFIDENTIAL text
  leftSideText: {
    width: 30,
  ...
  // Main content area of top section
  topMainContent: {
    flex: 1,
    justifyContent: "center",
    alignItems: "center",
  },
  // Employee name and address in center
  employeeInfo: {
    textAlign: "center",
    marginTop: 10,
    flex: 1,
  ...
  // Combined table structure for both sections
  payTable: {
    flexDirection: "row",
    height: 180,
    borderTop: "none",
  ...
  // Total sections (outside table but aligned)
  totalSection: {
    flexDirection: "row",
    height: 30,
    borderTop: "none",
  ...
  // Total rows as separate sections
  totalRowGross: {
    backgroundColor: "#FFFFFF",
    paddingVertical: 8,
    paddingHorizontal: 6,
  ...
  // Bottom sections - Updated styles
  bottomRow: {
    flexDirection: "row",
    height: 80,
  /*   border: "2px solid #000", */
  ...
  // EMPLOYER'S CONTRIBUTIONS section
    ...
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.topSection}>
        ...
        <View style={styles.leftSideText}>
              ...
              <Image src={k.src}    style={styles.privateText} ></Image>
      ...
      <View style={styles.mainContent}>
        ...
        <View style={styles.payRow}>
          ...
          <View style={styles.grossPaySection}>
            ...
            <View style={styles.payTable}>
              ...
              {/* Amount Column - WHITE BACKGROUND */}
            ...
            {/* Total Pay Row - Outside table but aligned */}
          ...
          <View style={styles.deductionsSection}>
            ...
            {/* Total Adjustments Row - Outside table but aligned */}
        ...
        <View style={styles.netPaySection}>
          ...
          <View style={{backgroundColor: "#fff", width:"50%",   paddingVertical: 5,
